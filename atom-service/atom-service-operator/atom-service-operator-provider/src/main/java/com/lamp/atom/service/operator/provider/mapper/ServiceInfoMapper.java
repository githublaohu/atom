...
public interface ServiceInfoMapper {
	 ...
	 */
	@Insert("insert into service_info" + "(space_id,si_name,si_type,si_runtime_pattern,si_node_num,si_image_name,"
	 ...
	 * @return
	 */
	@Update("update service_info set " + "delete_flag = #{deleteFlag} " + "where id = #{id}")
	 ...
	 * @return
	 */
	@Select("select * from service_info " + "where delete_flag = 0 and "

...
from operators.reasoning_operator import ReasoningOperatorRuntime
from operators.train_operator import TrainOperatorRuntime

from atom_runtime_api.operator.operators_api import OperatorApi
from operators.operator import OperatorRuntime
from rpc_service.rpc_operator_service import RpcOperatorServcie
from service.code_service import CodeService
from service.connect_service import ConnectService
    ...
    def __create_connect_and_source__(self):
        if self.operator_create_to.model_connect != None:
            ...
            if folder.exists()  == False:
                connect:Connect = self.operator_service.connect_service.get_connect(self.operator_create_to.model_connect)
                connect.download(self.operator_create_to.model_to.model_address,mode_path)
